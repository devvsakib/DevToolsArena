...
const errorType = ["All", "push", "commit", "merge", "pull", "add", "branch", "cmd"]
                    ...
                    width > 768 ? (
                        <ul className={`flex flex-col sm:flex-row mx-auto mt-2 items-start gap-4 py-3 px-6 rounded-lg bg-white w-full md:w-12/12  md:w-auto`}>
                            {
                                errorType.map((item, i) => (
                                    <li
                                        key={i}
                                        className={`${item === "add" ? "bg-[#4024e0]" : item === "commit" ? "bg-[#1a5ba5]" : item === "merge" ? "bg-[#118d7c]" : item === "push" ? "bg-[#8d54e1]" : item === "cmd" ? "bg-[#e100ff]" : item === "branch" ? "bg-[#40E4F0]" : "bg-[#7e1aa5]"
                                            }
                        ...
                        <div className="text-center">
                            ...
                            <ul className={`animate flex flex-col sm:flex-row mx-auto mt-2 items-start gap-4 py-3 pt-4 px-6 rounded-lg bg-white backdrop-blur-md w-[60vw] md:w-auto text-left ${open ? "hidden" : "block"}`}>
                                {
                                    errorType.map((item, i) => (
                                        <li key={i} className={`${item === "add" ? "bg-[#4024e0]" : item === "commit" ? "bg-[#1a5ba5]" : item === "merge" ? "bg-[#118d7c]" : item === "push" ? "bg-[#8d54e1]" : item === "cmd" ? "bg-[#40f058a8]" : item === "branch" ? "bg-[#40E4F0]" : "bg-[#7e1aa5]"
